...
<head>
	<meta charset="UTF-8">
	<title>Bee Cloud | Vuela alto, en la nube.</title>
...
<header class="main-header header-style-one">
            ...
            <div class="outer-box clearfix">
                <div class="header-top_right pull-right">
                    <div class="header-social-link-1">
                        <ul class="clearfix">
                            <li>
                                <a href="https://www.facebook.com/profile.php?id=61573530557221" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a> 
                            </li>
                            <li>
        ...
        <div class="container">
            <div class="outer-box">
                <div class="header-left">
                    <div class="logo">
                        <a href="/"><img src="assets/images/resources/logo.png" alt="BeeCloud Logo" title=""></a>
                    </div>
                </div>
                    ...
                    <div class="header-right_buttom">
                        <div class="btns-box">
                            <a class="btn-one" href="#contact">
                                ...
                                <span class="txt">¡Contactanos!<i class="flaticon-plus-1 plusicon"></i></span>
                            </a>
                        </div>
                    </div> 
    ...
    <div class="mobile-menu">
        ...
        <nav class="menu-box">
            <div class="nav-logo"><a href="/"><img src="assets/images/resources/logo.png" alt="" title=""></a></div>
            <div class="menu-outer"><!--Here Menu Will Come Automatically Via Javascript / Same Menu as in Header--></div>
            <!--Social Links-->
            <div class="social-links">
                <ul class="clearfix">
                    <li><a href="#"><span class="fab fa fa-facebook-square"></span></a></li>
                    <li><a href="#"><span class="fab fa fa-instagram-square"></span></a></li>
...
<section id="banner" class="main-slider style1">
    ...
    <div class="slider-contact-info">
        ...
        <div class="title">
            <h5>WhatsApp</h5>
            <h3><a href="https://wa.me/+5214462906191" target="_blank">4462906191</a></h3>
        </div>
    </div>
        ...
        <div class="banner-carousel owl-theme owl-carousel">
            ...
            <div class="slide">
                ...
                <div class="auto-container">
                    <div class="content text-center">
                        <div class="big-title">
                            <h2>Libertad de personalizar y adaptar la tecnología a tus necesidades.</h2>
                        </div>
                        <div class="btns-box center">
                            <a class="btn-one" href="https://wa.me/+5214462906191" target="_blank">
                                 <div class="border_line"><img src="assets/images/shape/button-border.png" alt=""></div>
                                <span class="txt">Descubre más.<i class="flaticon-plus-1 plusicon"></i></span>
                            </a>
                            <a class="btn-one style2 marlft15" href="/">
                                <div class="border_line"><img src="assets/images/shape/button-border.png" alt=""></div>
                                <span class="txt">Inicia ahora!<i class="flaticon-plus-1 plusicon"></i></span>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="slide">
                ...
                <div class="auto-container">
                    <div class="content text-center">
                        <div class="big-title">
                            <h2>Somos eficientes reduciendo costos y aumentando la productividad.</h2>
                        </div>
                        <div class="btns-box center">
                            <a class="btn-one" href="https://wa.me/+5214462906191" target="_blank">
                                <div class="border_line"><img src="assets/images/shape/button-border.png" alt=""></div>
            ...
            <div class="slide">
                ...
                <div class="auto-container">
                    <div class="content text-center">
                        <div class="big-title">
                            <h2>Confía en las marcas open source líderes.<br>"Vuela alto, en la nube."</h2>
                        </div>
                        <div class="btns-box center">
                            <a class="btn-one" href="https://wa.me/+5214462906191" target="_blank">
                                <div class="border_line"><img src="assets/images/shape/button-border.png" alt=""></div>
...
<section id="about" class="about-style1-area">
    <div class="container">
        <div class="sec-title text-center">
            ...
            <h2>Alcanza tu maximo potencial<br> inovamos tu start up con soluciones tecnologicas.</h2>
        </div>
        <div class="row">
            ...
            <div class="col-xl-6">
                <div class="about-style1_image-box clearfix">
                    ...
                    <div class="inner-caption"><h3>24 Años trabajando<br> con sistemas.</h3></div>
                    <div class="image-box left">
                        ...
                        <a class="video-popup xoven-video-galler-1" title="Xoven Video Gallery" href="/assets/videos/dense-clouds-over-mountain-valley-at-sunset-2023-11-27-04-53-29-utc.mp4">
            ...
            <div class="col-xl-6">
                <div class="about-style1_content-box">
                    <h3>Nacimos con el único proposito de evolucionar negocios a nivel tecnológico!</h3>
                    <h2>“Vuela alto, en la nube.”</h2>
                    <div class="text">
                        <p>En <span>BeeCloud</span>, nos enfocamos en diseñar y desarrollar soluciones tecnologicas innovadoras y personalizadas en la nube, para ayudar a las empresas y organizaciones a alcanzar su maximo potencial.</p>
                    </div>
...
<section class="partner-area">
    <div class="container">
        <div class="partner-title text-center">
            <h2>Respaldados por <span>1000M+</span> Proyectos<br>Open Source y Software con Licencia.</h2>
...
<section id="services" class="service-style1-area">
    <div class="service-style1-area_bg" style="background-image: url(assets/images/parallax-background/service-style1-area_bg.jpg);"></div>
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="single-service-style1">
                    ...
                    <div class="title">
                        <h3><a href="#">Migración a la Nube</a></h3>
                        <div class="inner-text">
                            <p>Ayudamos a las empresas a migrar sus aplicaciones y datos a la nube de manera segura y eficiente, reduciendo costos y mejorando la escalabilidad.</p>
                        </div>
                    </div>
                </div>
            </div> 
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="single-service-style1">
                    ...
                    <div class="title">
                        <h3><a href="#">Diseño y Implementación de Infraestructura en la Nube</a></h3>
                        <div class="inner-text">
                            <p>Creamos infraestructuras en la nube personalizadas y seguras para satisfacer las necesidades específicas de cada negocio.</p>
                        </div>
                    </div>
                </div>
            </div> 
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="single-service-style1">
                    ...
                    <div class="title">
                        <h3><a href="#">Administración y Monitoreo de Recursos en la Nube.</a></h3>
                        <div class="inner-text">
                            <p>Nuestros expertos administran y monitorean tus recursos en la nube para garantizar su disponibilidad y rendimiento óptimo.</p>
                        </div>
                    </div>
                </div>
            </div> 
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="single-service-style1">
                    ...
                    <div class="title">
                        <h3><a href="#">Almacenamiento y Respaldo en la Nube.</a></h3>
                        <div class="inner-text">
                            <p>Ofrecemos soluciones de almacenamiento y respaldo en la nube seguras y escalables para proteger los datos críticos de tu empresa.</p>
                        </div>
                    </div>
                </div>
            </div> 
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="single-service-style1">
                    ...
                    <div class="title">
                        <h3><a href="#">Seguridad y Cumplimiento en la Nube.</a></h3>
                        <div class="inner-text">
                            <p>Proporcionamos servicios de seguridad avanzados para proteger tus activos en la nube y asegurar el cumplimiento de normativas y regulaciones.</p>
                        </div>
                    </div>
                </div>
            </div> 
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="single-service-style1">
                    ...
                    <div class="title">
                        <h3><a href="#">Consultoría y Optimización de Costos en la Nube.</a></h3>
                        <div class="inner-text">
                            <p>Análizamos tus necesidades y ofrecemos recomendaciones personalizadas para optimizar tus costos en la nube y maximizar el retorno de la inversión.</p>
                        </div>
                    </div>
                </div>
            </div> 
            ...
            <div class="col-xl-4 col-lg-6 col-lg-6">
                <div class="single-team-style1 wow fadeInRight animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                    ...
                    <div class="title-holder">
                        ...
                        <div class="social-links">
                            <ul>
                                <li><a href="https://www.facebook.com/profile.php?id=61573530557221" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                            </ul> 
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-12">
                <div class="xoven-video-gallery-2 text-center">
                    <div class="big-title paroller">
                        <h2><span>Hey!</span>Conecta tu start up<br> a la nube.</h2>
                    </div>
                    <p class="paroller">¡Únete a nuestro programa de emprendedores y convierte tus ideas en realidad!<br> Contactanos por WhatsApp para más información.</p>
...
<section id="news" class="blog-style1-area">
    <div class="container">
        <div class="sec-title text-center">
            ...
            <h2>Construimos plataformas y estudios web<br> digitales preparados para el futuro.</h2>
        </div>
        <div class="row text-right-rtl">
            ...
            <div class="col-xl-6 col-lg-6">
                <div class="single-blog-style1 wow fadeInUp" data-wow-duration="1500ms">
                    ...
                    <div class="text-holder">
                        <h3 class="blog-title">
                            <a href="blog-single.html">Flexibilidad y Escalabilidad.<br></a>
                        </h3>
                        <div class="text">
                            <p>La nube ofrece una flexibilidad y escalabilidad sin precedentes. Con la nube, las empresas pueden escalar sus recursos de manera rápida y fácil, según sea necesario. Esto significa que no hay que preocuparse por la capacidad de almacenamiento o la potencia de procesamiento, ya que la nube se encarga de todo. Además, la nube permite el acceso a los datos y aplicaciones desde cualquier lugar y en cualquier momento.</p>
                        </div>
            ...
            <div class="col-xl-6 col-lg-6">
                <div class="single-blog-style1 wow fadeInUp" data-wow-duration="1500ms">
                    ...
                    <div class="text-holder">
                        <h3 class="blog-title">
                            <a href="blog-single.html">Reducción de Costos y Mayor Seguridad.<br></a>
                        </h3>
                        <div class="text">
                            <p>La migración a la nube también puede ayudar a reducir los costos y mejorar la seguridad. Al no tener que mantener y actualizar el hardware y software, las empresas pueden ahorrar dinero en costos de infraestructura y mantenimiento. Además, la nube ofrece una seguridad avanzada, con medidas como la autenticación de dos factores, la cifrado de datos y la protección contra malware y otros ataques cibernéticos.</p>
                        </div>
                        <div class="bottom-box">
                            <div class="btns-box">
                                <a class="btn-one" href="/#contact">
                ...
                <div class="fact-counter_box">
                    <ul class="clearfix">
                        <li class="single-fact-counter wow slideInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                            ...
                            <div class="outer-box">
                                <div class="count-outer count-box">
                                    <span class="count-text" data-speed="3000" data-stop="9125">0</span>
                                </div>
                                <div class="title">
                                    <h6>Tazas de Té.</h6>
                                </div>
                        ...
                        <li class="single-fact-counter wow slideInLeft" data-wow-delay="500ms" data-wow-duration="1500ms">
                            ...
                            <div class="outer-box">
                                <div class="count-outer count-box">
                                    <span class="count-text" data-speed="3000" data-stop="300000">0</span>
                                </div>
                                <div class="title">
                                    <h6>Lineas de codigo escritas.</h6>
                                </div>
                            </div>  
                        </li>
                        ...
                        <li class="single-fact-counter wow slideInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
                            ...
                            <div class="outer-box">
                                ...
                                <div class="title">
                                    <h6>Instalaciones de sistema operativo.</h6>
                                </div>
                            </div>  
                        </li>
                    </ul>
...
<section class="testimonial-style1-area pdbottom240"> 
    <div class="container">
        <div class="testimonial-style1_title">
            <h2>Opiniones de nuestros <span>clientes?</span></h2>
        </div>
        <div class="row">
            <div class="col-xl-12">
                <div class="testimonial-style1-content">
                    <div class="testimonial-style1-carousel owl-carousel owl-theme">
                        ...
                        <div class="single-testimonial-style1">
                            ...
                            <div class="text-holder">
                                <div class="text">
                                    <h3>"La consultora en informática nos brindó una asesoría excelente y soluciones personalizadas que se adaptaron perfectamente a nuestras necesidades. Su equipo de expertos nos ayudó a optimizar nuestros procesos y a mejorar nuestra infraestructura tecnológica. La atención al cliente fue impecable y siempre estuvieron disponibles para resolver nuestras dudas y preocupaciones. Sin duda, los recomendamos a cualquier empresa que busque mejorar su tecnología y procesos."</h3>
                                </div>
                                <div class="client-info">
                                    ...
                                    <div class="inner-title">
                                        <h4>Ana Sofía Gómez</h4>
                                        <h6>Directora Ejecutiva</h6>
                                    </div>
                                </div>
                            </div> 
                        </div>
                        ...
                        <div class="single-testimonial-style1">
                            ...
                            <div class="text-holder">
                                <div class="text">
                                    <h3>"La consultora en informática nos ayudó a implementar soluciones tecnológicas que mejoraron significativamente nuestra productividad y eficiencia. Su equipo de expertos nos brindó una asesoría detallada y nos ayudó a seleccionar las herramientas y tecnologías adecuadas para nuestras necesidades. La implementación fue rápida y sin problemas, y el soporte posterior fue excelente. Estamos muy satisfechos con los resultados y los recomendamos a cualquier empresa que busque mejorar su productividad y eficiencia."</h3>
                                </div>
                                <div class="client-info">
                                    <div class="img-box">
                                        <img src="assets/images/testimonial/testimonial-v1-1.jpg" alt=""> 
                                    ...
                                    <div class="inner-title">
                                        <h4>Luis Enrique Ramírez</h4>
                                        <h6>Gerente de Proyectos</h6>
                                    </div>
                                </div>
                            </div> 
                        </div>
                        ...
                        <div class="single-testimonial-style1">
                            ...
                            <div class="text-holder">
                                <div class="text">
                                    <h3>"La consultora en informática nos ha brindado una tranquilidad y confianza absolutas en la gestión de nuestros sistemas. Su equipo de expertos es muy profesional y siempre está disponible para resolver cualquier problema o duda que tengamos. La gestión de nuestros sistemas es ahora más eficiente y segura, y podemos enfocarnos en nuestro negocio sin preocuparnos por la tecnología. Los recomendamos a cualquier empresa que busque una consultora en informática confiable y eficiente."</h3>
                                </div>
                                <div class="client-info">
                                    <div class="img-box">
                                        <img src="assets/images/testimonial/testimonial-v1-1.jpg" alt=""> 
                                    ...
                                    <div class="inner-title">
                                        <h4>Valeria Elizabeth Morales</h4>
            ...
            <div class="col-xl-12">
                <div class="contact-style1_inner-box">
                    ...
                    <div class="contact-style1_form">
                        <div class="top-title">
                            <h3>!Contactanos¡</h3>
                            <p>Nuestro equipo está comprometido con la calidad y la innovación. Queremos conocer tus necesidades y trabajar contigo para encontrar soluciones eficientes.</p>
                        </div>
                        <div class="contact-form">
                            <form id="contact-form" name="contact_form" class="default-form2" action="formulario_contacto.php" method="post">
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="input-box"> 
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="input-box">
                                            ...
                                            <input type="text" name="form_phone" value="" placeholder="Telefono:" required="">
                                        </div>   
                                    </div>
                                    <div class="col-xl-6">
                                        <div class="input-box">
                                ...
                                <div class="row">
                                    <div class="col-xl-12">
                                        <div class="input-box">
                                            <label>Mensaje</label>    
                                            <textarea name="form_message" placeholder="Escribe tu mensaje..." required=""></textarea>
                                        </div>
                                        <div class="button-box">
                                            <input id="form_botcheck" name="form_botcheck" class="form-control" type="hidden" value="">
                                            <button class="btn-one" type="submit" data-loading-text="Espere ...">
                                                <span class="border_line"><img src="assets/images/shape/button-border.png" alt=""></span>
                                                <span class="left_round"></span>
                                                <span class="right_round"></span>
                                                <span class="txt">Envia tu mensaje<i class="flaticon-plus-1 plusicon"></i></span>
                                            </button> 
                                        </div>     
                                    </div>
                                </div>
...
-->
                            <li>
                                <div class="inner">
                                    ...
                                    <div class="inner_text">
                                        <p><a href="https://wa.me/+524462906191" target="_blank">4462906191</a></p>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="inner">
                                    ...
                                    <div class="inner_text">
                                        <p><a href="mailto:contacto@beecloud.com.mx" class="underline">contacto@beecloud.com.mx</a></p>
                                    </div>
                                </div>
                            </li>
<!--
                                ...
                                <div class="inner">
                                    ...
                                    <div class="inner_text">
                                        <ul class="social-link">
                                            <li><a href="https://www.facebook.com/profile.php?id=61573530557221" target="_blank"><i class="fa fa-facebook"></i></a></li>
...
<footer class="footer-area">
    <div class="footer-area_bg" style="background-image: url(assets/images/parallax-background/footer-area_bg.jpg);"></div>
    <div class="shape">
                ...
                <div class="col-xl-12">
                    <div class="inner">
                        <div class="text">
                            ...
                            <h6>¡Nosotros si!, Estamos preparados para colaborar contigo y llevar tu negocio al siguiente nivel.</h6>
                        </div>
                        <div class="button-box">
                            <a class="btn-one" href="#contact">
                                <div class="border_line"><img src="assets/images/shape/button-border.png" alt=""></div>
                                <span class="txt">¡Comienza ahora!<i class="flaticon-plus-1 plusicon"></i></span>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 wow animated fadeInUp" data-wow-delay="0.1s">
                    <div class="single-footer-widget">
                        <div class="our-company-info">
                            ...
                            <div class="text-box">
                                <p>Desbloquea el potencial de tu negocio con las soluciones en la nube. ¡Escalabilidad, seguridad y eficiencia al alcance de tu mano!"</p>
                            </div>
                            <div class="copyright-text">
                                <p>&copy; Desarrollado por <a href="#banner">@BeeCloud.</a></p>
                            </div>
                        </div>     
                    </div>
                </div>
